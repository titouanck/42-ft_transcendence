...
class Match(models.Model):
	...
	left_player = models.ForeignKey(Player, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_left_player_uid')
	...
	right_player = models.ForeignKey(Player, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_right_player_uid')
	...
	match_winner = models.ForeignKey(Player, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_match_winner_uid')
	match_looser = models.ForeignKey(Player, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_match_looser_uid')
	
	match_started_at = models.DateTimeField(blank=True, null=True)
	match_ended_at = models.DateTimeField(blank=True, null=True)
	
	tournament = models.ForeignKey(Tournament, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_tournament_uid')
	tournament_round = models.ForeignKey(TournamentRound, on_delete=models.SET_NULL, blank=True, null=True, related_name='match_tournament_round_uid')
